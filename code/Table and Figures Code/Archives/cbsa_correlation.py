...
wharton = pd.read_stata("/Users/gaocixin/Dropbox/Inclusionary Zoning/Github/ai-zoning/raw data/WRLURI_01_15_2020.dta")
...
ourindex = pd.read_excel("/Users/gaocixin/Dropbox/Inclusionary Zoning/Github/ai-zoning/processed data/Model Output/Full Run/Overall_Index.xlsx")
geoid = [i[-9:-3] for i in ourindex["Muni"]]
ourindex["geoid"] = geoid

census = pd.read_excel("/Users/gaocixin/Dropbox/Inclusionary Zoning/Github/ai-zoning/raw data/census_of_gov.xlsx")
...
cbsa2017 = pd.read_csv("/Users/gaocixin/Dropbox/Inclusionary Zoning/Github/ai-zoning/raw data/cbsa_2017.csv")
