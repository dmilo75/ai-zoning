...
def plot_map_for_size(size_name, figsize, df, gdf_states, fontsize, ak_gdf, hi_gdf, col):
...
for col in df.columns[1:]:
    ...
    for size_name, figsize in sizes.items():
        print()
        plot_map_for_size(size_name, figsize, df, gdf_states, fontsize, ak_gdf, hi_gdf, col)
